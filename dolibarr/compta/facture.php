 ...
 *	\version    $Id: facture.php,v 1.789.2.4 2011/02/22 16:01:17 hregis Exp $
 */
...
{
    print '<p><a href="'.DOL_URL_ROOT.'/public/paypal/newpayment.php?source=invoice&ref='.$object->ref.'&tag=500" target="_blank">Régler le 1er acompte (50%) par Paypal</a></p>';
...
llxFooter('$Date: 2011/02/22 16:01:17 $ - $Revision: 1.789.2.4 $');
?>
