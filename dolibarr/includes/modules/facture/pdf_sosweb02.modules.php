...
/**
 *	\file       htdocs/includes/modules/facture/pdf_sosweb02.modules.php
 *	\ingroup    facture
 *	\brief      File of class to generate invoices from crab model
 *	\author	    Laurent Destailleur
 *	\version    $Id: pdf_sosweb02.modules.php,v 1.298 2011/01/03 09:50:08 eldy Exp $
 */
...
/**
 *	\class      pdf_sosweb02
 *	\brief      Classe permettant de generer les factures au modele sosweb02
 */

class pdf_sosweb02 extends ModelePDFFactures
{
...
// patched by Alain
require_once(DOL_DOCUMENT_ROOT."/includes/modules/sosweb_addon/sw_mysoc.php");
...
// patch by Alain
				...
				// $pdf->MultiCell(80, 5, $this->paypal_url,0,'L');	//  :: a payer:: ".price($object->total_ttc*.5)
				// bad ...$pdf->SetLink("http://sosweb.ch");
				// ok ... $pdf->addHtmlLink("http://sosweb.ch", "ceci est mon lien", $fill=false, $firstline=false, $color='green', $style=-1, $firstblock=false);
				$sw_file=DOL_DOCUMENT_ROOT."/includes/modules/sosweb_addon/btn_paypal.gif";
				// pdf->Image($sw_file, $x='10', $y='10', $w=0, $h=0, $type='', $link='http://sosweb.ch', $align='L');
				$pdf->Image($sw_file, '', '', 0, 0, '', $this->paypal_url, 'L');
				// $pdf->WriteHTML("<pre>hello world!!!!!</pre>");
				// $pdf->WriteHTML($this->paypal_btn);
				$posy=$pdf->GetY()+2;
 if($object->statut == 1 && $resteapayer > 0)
{   print '<p><a href="'.DOL_URL_ROOT.'/public/paypal/newpayment.php?source=invoice&ref='.$object->ref.'" target="_blank">Régler ma facture par Paypal</a></p>';
}
	...
	function _pagehead(&$pdf, $object, $showaddress=1, $outputlangs)
	{
		...
		// patch by Alain 
		$logo=DOL_DOCUMENT_ROOT."/includes/modules/sosweb_addon/".$this->emetteur->logo;
