...
/**
 *	\file       htdocs/includes/modules/propale/pdf_propale_sosweb01.modules.php
 *	\ingroup    propale
 *	\brief      Fichier de la classe permettant de generer les propales au modele sosweb01
 *	\author	    Laurent Destailleur
 *	\version    $Id: pdf_propale_sosweb01.modules.php,v 1.229.2.1 2011/03/09 10:50:55 hregis Exp $
 */
...
/**
 *	\class      pdf_propale_sosweb01
 *	\brief      Classe permettant de generer les propales au modele sosweb01
 */
class pdf_propale_sosweb01 extends ModelePDFPropales
{
	 ...
	 */
	function pdf_propale_sosweb01($db)
	{
		...
		// Recupere emmetteur
		$this->emetteur=$mysoc;		// original code
...
*/
	...
	function _tableau_info(&$pdf, $object, $posy, $outputlangs)
	{
		...
		if ($object->type != 2)
		{
			...
			{
				$pdf->SetXY($this->marge_gauche, $posy);
				$pdf->SetTextColor(0,0,0);		// patched by Alain (200,0,0);
				$pdf->SetFont('','B', $default_font_size - 2);
//				$pdf->MultiCell(90, 3, $outputlangs->transnoentities("ErrorNoPaiementModeConfigured"),0,'L',0);
				$pdf->MultiCell(90, 3, "ici le texte du bouton PayPal",0,'L',0);
				$pdf->SetTextColor(0,0,0);
	...
	{
		return pdf_pagefoot($pdf,$outputlangs,'SW_PROPALE_FREE_TEXT',$this->emetteur,$this->marge_basse,$this->marge_gauche,$this->page_hauteur,$object);
	}
