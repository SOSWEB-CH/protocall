 ...
 *  \version    $Id: filefunc.inc.php,v 1.3.2.3 2011/07/10 13:19:38 eldy Exp $
 */

define('DOL_VERSION','3.0.1');	// Also defined in htdocs/install/inc.php (Ex: x.y.z-alpha, x.y.z)
define('EURO',chr(128));
